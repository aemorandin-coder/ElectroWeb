...
export async function GET() {
  try {
    ...
    const publicSettings = {
      ...
      shippingCostPerKg: (settings as any).shippingCostPerKg ? Number((settings as any).shippingCostPerKg) : 2,
      minConsolidatedShipping: (settings as any).minConsolidatedShipping ? Number((settings as any).minConsolidatedShipping) : 3,
      packagingFeeUSD: (settings as any).packagingFeeUSD ? Number((settings as any).packagingFeeUSD) : 2.50,
