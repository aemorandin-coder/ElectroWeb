...
export default function CertificatePage({ certificateId, studentName, completedAt, course }: Props) {
  ...
  return (
    <div className="min-h-dvh bg-surface flex flex-col">
      {/* Nav */}
      <nav className="bg-white border-b border-line px-6 py-3 flex items-center justify-between print:hidden">
        <Link href="/" className="font-bold text-brand-500 text-lg">ElectroShop</Link>
        <div className="flex items-center gap-3">
          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-success/15 text-success-strong text-xs font-bold rounded-full">
          ...
          <button
            ...
            type="button"
            className="flex items-center gap-2 px-4 py-2 bg-brand-500 text-white text-sm font-bold rounded-lg hover:bg-brand-600 transition-colors"
          >
      ...
      <div className="print:hidden text-center py-6 px-4">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-success/15 border border-success/30 rounded-full">
          <svg className="w-4 h-4 text-success-strong" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
          </svg>
          <p className="text-success-strong text-sm font-semibold">
