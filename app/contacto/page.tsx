          ...
          <div className="space-y-4">
            ...
            {settings?.whatsapp && (
              ...
              >
                ...
                <div className="relative flex items-start gap-4 p-5 bg-white/80 backdrop-blur-xl rounded-2xl border border-[#e9ecef] shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                  <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#2a63cd] to-[#1e4ba3] rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-sm font-semibold text-[#2a63cd] group-hover:text-[#1e4ba3]">
                      {settings.whatsapp}
                    </span>
                  </div>
                  <svg className="w-5 h-5 text-[#6a6c6b] group-hover:text-[#2a63cd] group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
