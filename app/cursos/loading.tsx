                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {Array.from({ length: 6 }).map((_, i) => (
                        <div key={i} className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100">
                            <div className="w-full h-48 bg-[#e9ecef] animate-pulse" />
                            <div className="p-6">
                                <div className="w-20 h-5 bg-[#e9ecef] rounded-full mb-3 animate-pulse" />
                                <div className="w-4/5 h-6 bg-[#e9ecef] rounded mb-3 animate-pulse" />
                                <div className="w-full h-4 bg-[#e9ecef] rounded mb-2 animate-pulse" />
                                <div className="w-2/3 h-4 bg-[#e9ecef] rounded mb-4 animate-pulse" />
                                <div className="flex justify-between items-center">
                                    <div className="w-24 h-8 bg-[#e9ecef] rounded animate-pulse" />
                                    <div className="w-28 h-10 bg-[#e9ecef] rounded-lg animate-pulse" />
                                </div>
                            </div>
                        </div>
                    ))}
