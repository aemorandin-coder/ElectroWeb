                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {Array.from({ length: 6 }).map((_, i) => (
                        <div key={i} className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                            <div className="w-full h-40 bg-[#e9ecef] rounded-xl mb-4 animate-pulse" />
                            <div className="w-3/4 h-6 bg-[#e9ecef] rounded mb-3 animate-pulse" />
                            <div className="w-1/2 h-4 bg-[#e9ecef] rounded mb-4 animate-pulse" />
                            <div className="w-full h-10 bg-[#e9ecef] rounded-lg animate-pulse" />
                        </div>
                    ))}
                </div>
            </div>
