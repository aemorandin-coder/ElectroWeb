      ...
      >
        ...
        <div className="p-5 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-gray-50 to-white">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-base font-bold text-ink">Compartir y Ganar</h2>
          ...
          <button
            ...
            className="w-8 h-8 rounded-full flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-ink transition-all"
        ...
        <div className="p-5 overflow-y-auto space-y-5 flex-1 scrollbar-hide">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-2">
              <input
                ...
                readOnly
                value={finalLink}
                className="flex-1 bg-gray-50 border border-gray-200 rounded-xl px-3 py-2 text-xs font-mono text-gray-700 focus:outline-none focus:border-brand-500 select-all"
              />
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-semibold flex items-center gap-1.5 transition-all shadow-sm ${
                  copied
                    ...
                    : 'bg-brand-500 text-white hover:bg-brand-600 shadow-blue-100'
                }`}
              >
          ...
          {!hasReferralCode && (
            <div className="bg-gradient-to-br from-brand-600/5 to-brand-500/10 border border-brand-500/15 rounded-2xl p-4 space-y-3">
              ...
              <div className="pt-1 flex items-center justify-between border-t border-gray-150/40">
                ...
                {referralData === null ? (
                  <a
                    ...
                    className="px-3.5 py-1.5 bg-brand-500 hover:bg-brand-600 text-white text-[11px] font-bold rounded-lg shadow-sm hover:scale-[1.02] active:scale-95 transition-all flex items-center gap-1"
                  >
                    Crear cuenta gratis
